...
@section('page_content')
    ...
    <div id="main">
        ...
        <header id="page-header">
            <h2 class="page-title">Rejeceted Registrations</h2>
                ...
                <tbody>
                    @foreach ($students as $student)
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <button class="action-update" data-id="{{ $student->id }}">Accept</button>
                                    <button class="action-delete" data-id="{{ $student->id }}">Reject</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
